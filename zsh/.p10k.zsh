# Generated by Powerlevel10k configuration wizard on 2020-11-17 at 15:14 PST.
...
() {
  ...
  typeset -g POWERLEVEL9K_DIR_PREFIX="%F{grey%}["
  typeset -g POWERLEVEL9K_DIR_SUFFIX="%F{grey%}]"
